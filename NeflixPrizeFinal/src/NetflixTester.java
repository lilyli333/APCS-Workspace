...
public class NetflixTester {
	...
	public static final String baseFile = "testers" + FileIO.fileSeparator + "1Ratings.csv";
	public static final String testFile = "testers" + FileIO.fileSeparator + "1Tests.csv";
